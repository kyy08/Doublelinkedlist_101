...
void  DoubleLinkedList::hapus() {
	...
	cout << "\nEnter the roll number of the student whose the record is to be deleted: ";
	int rollNo;
	cin >> rollNo;
	cout << endl;
...
void DoubleLinkedList::searchData() {
	...
	Node* prev, * curr;
	prev = curr = NULL;
	cout << "\nEnter the rolll number of the student whose record ypu want to search: ";
	int num;
	cin >> num;
...
int main() {
	...
	while (true) {
		try {
			...
			cout << "3. View all records in the ascending order off roll number" << endl;
			cout << "4. View all records in the descending order off roll number" << endl;
